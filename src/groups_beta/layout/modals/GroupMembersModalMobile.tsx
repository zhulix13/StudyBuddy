...
interface GroupMembersModalMobileProps {
  isOpen: boolean
  onClose: () => void
  groupId: string
  groupName: string
...
const GroupMembersModalMobile = ({ isOpen, onClose, groupId, groupName }: GroupMembersModalMobileProps) => {
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center gap-3 p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#111827] sticky top-0 z-10 shadow-sm">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white">Group Members</h1>
            ...
            {isLoading ? (
              ...
              <div className="p-4 space-y-3">
                {members.map((member) => (
                  ...
                  >
                    <Avatar className="w-12 h-12 ring-2 ring-white dark:ring-gray-600 shadow-sm">
...
export default GroupMembersModalMobile
